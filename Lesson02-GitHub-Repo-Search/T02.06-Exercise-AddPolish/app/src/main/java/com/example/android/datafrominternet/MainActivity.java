...
public class MainActivity extends AppCompatActivity {
    ...
    private ProgressBar mProgressBarVariable;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProgressBarVariable = (ProgressBar) findViewById(R.id.pb_loading_indicator);
    ...
    private void showJsonDataView(JSONObject json){
