...
public class MainActivity extends AppCompatActivity {
    ...
    void makeGithubSearch() {
        String urlPass = mSearchBoxEditText.getText().toString();
        URL newUrl = NetworkUtils.buildUrl(urlPass);
        mUrlDisplayTextView.setText(newUrl.toString());
